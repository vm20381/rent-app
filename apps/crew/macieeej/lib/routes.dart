...
import 'package:macieeej/views/chat/chat_page.dart';
...
getPageRoute() {
  var routes = [
    ...
    GetPage(
      name: '/chat', // Replace 'new-page' with the desired route name
      page: () => const ChatPage(), // Replace 'NewPage' with the actual page widget
      middlewares: [AuthMiddleware()],
    ),
  ];
  return routes
