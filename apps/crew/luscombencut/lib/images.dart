...
class Images {
  ///----------------- Brand -----------------------------------//
  static String logoIcon = 'assets/images/logo/ca_logo.png';

  ///----------------- Dummy Image -----------------------------------//

  static List<String> avatars = List.generate(
    12,
    (index) => 'assets/images/dummy/avatar-${index + 1}.jpg',
  );
  ...
  static List<String> dashboard = List.generate(
    6,
    (index) => 'assets/images/dummy/dashboard-${index + 1}.jpg',
  );

  static List<String> fileManager = List.generate(
    2,
    (index) => 'assets/images/dummy/fileManager-${index + 1}.jpg',
  );

  static List<String> landing = List.generate(
    3,
    (index) => 'assets/images/dummy/landing-${index + 1}.jpg',
  );

  static List<String> social = List.generate(
    5,
    (index) => 'assets/images/dummy/social-${index + 1}.jpg',
  );
  ...
  static String loginCustom = 'assets/images/dummy/pugwash.png';
  ...
  static List<String> shoppingImage = List.generate(
    10,
    (index) => 'assets/images/shopping_images/photo${index + 1}.jpg',
  );
