...
class _EntityDetailState extends State<EntityDetail>
  ...
  late EntityDetailController controller;
  late FileUploaderController fileUploaderController;
  late FileDownloadController fileDownloaderController;

  @override
  void initState() {
    super.initState();
    controller = Get.put(EntityDetailController());
    fileUploaderController = Get.put(FileUploaderController());
    fileDownloaderController = Get.put(FileDownloadController());
    controller.fetchEntityDetails(Get.parameters['entityId']!);
  }
                  ...
                  children: [
                    ...
                    MyBreadcrumb(
                      children: [
                        ...
                        MyBreadcrumbItem(name: 'Asset Detail', active: true),
                      ],
                    ),
                  ],
                ),
              ...
              Obx(() {
                ...
                return Column(
                  children: [
                    ...
                    SvgPicture.network(
                      controller.getEntityQRCodeUrl(entity.id),
                                  ...
                                  child: MyCard(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        // Remove Expanded
                                        GetBuilder(
                                          init: fileDownloaderController,
                                          builder: (controller) {
                                            return SizedBox(
                                              height:
                                                  200, // maintain fixed height
                                        ...
                                        MySpacing.height(16),
                                        FileUploadWidget(
                                          entityId: Get.parameters['entityId']!,
                                        ),
                                      ],
                                    ),
                                  ),
