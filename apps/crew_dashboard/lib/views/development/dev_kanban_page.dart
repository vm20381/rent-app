...
import 'package:captainapp_crew_dashboard/controller/dev/dev_kanban_controller.dart';
...
class DevKanBanPage extends StatefulWidget {
  const DevKanBanPage({Key? key}) : super(key: key);

  @override
  State<DevKanBanPage> createState() => _DevKanBanPageState();
}

class _DevKanBanPageState extends State<DevKanBanPage>
    with SingleTickerProviderStateMixin, UIMixin {
  late DevKanBanController controller;
  late ScrollController _controller;

  @override
  void initState() {
    super.initState();
    controller = Get.put(DevKanBanController());
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    MyBreadcrumb(
                      children: [
                        MyBreadcrumbItem(name: 'Development'),
