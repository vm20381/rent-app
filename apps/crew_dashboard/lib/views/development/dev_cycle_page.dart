...
class _DevCyclePageState extends State<DevCyclePage>
    with SingleTickerProviderStateMixin, UIMixin {
  late DevCycleController controller;
  late ScrollController _controller;

  @override
  void initState() {
    super.initState();
    controller = Get.put(DevCycleController());
                  ...
                  children: [
                    ...
                    MyBreadcrumb(
                      children: [
                        ...
                        MyBreadcrumbItem(name: 'Cycle', active: true),
                      ],
                    ),
                  ],
                ),
