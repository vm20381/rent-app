import 'package:captainapp_crew_dashboard/controller/ui/notifications_controller.dart';
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      MySpacing.height(20),
                                      MyText.labelLarge(
                                        "color_variant".tr().capitalizeWords,
                                      ),
                                      MySpacing.height(8),
                                      MyContainer.bordered(
                                        paddingAll: 12,
                                      ...
                                      if (!controller.showBanner) ...[
                                        MyText.labelLarge(
                                          "floating_type".tr().capitalizeWords,
                                        ),
                                        MySpacing.height(8),
                                        MyContainer.bordered(
                                          width: double.infinity,
                                          ...
                                          child: Wrap(
                                            spacing: 16,
                                            children: SnackBarBehavior.values
                                                .map(
                                                  (behavior) => InkWell(
                                                    onTap: () => controller
                                                        .onChangeBehavior(
                                      ...
                                      CheckboxListTile(
                                        ...
                                        onChanged:
                                            controller.onChangeShowCloseIcon,
                                        controlAffinity:
                                      ...
                                      if (!controller.showBanner)
                                        CheckboxListTile(
                                          ...
                                          onChanged:
                                              controller.onChangeShowOkAction,
                                          controlAffinity:
                                              ListTileControlAffinity.leading,
                                          visualDensity: getCompactDensity,
                                          contentPadding: MySpacing.zero,
                                      ...
                                      if (controller.showBanner)
                                        CheckboxListTile(
                                          value: controller.showLeadingIcon,
                                          onChanged: controller
