...
class _LandingPageState extends State<LandingPage>
                              ...
                              MyFlexItem(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    MySpacing.height(28),
                                    buildFAQItem(
                                      "Will you regularly give updates of Captain App?",
                                      controller.dummyTexts[1],
                                    ),
                                  ],
                                ),
  ...
  Widget buildFooterData(
    String footerTitle,
    String footerSubTitle1,
    String footerSubTitle2,
    String footerSubTitle3,
    String footerSubTitle4,
  ) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
